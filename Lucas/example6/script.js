...
const definitionName = "sphere.gh";
...
const PtCount_slider = document.getElementById("PtCount");
PtCount_slider.addEventListener("mouseup", onSliderChange, false);
PtCount_slider.addEventListener("touchend", onSliderChange, false);
...
async function compute() {
  ...
  const param2 = new RhinoCompute.Grasshopper.DataTree("PtCount");
  param2.append([0], [PtCount_slider.valueAsNumber]);
